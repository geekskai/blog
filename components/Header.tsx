...
const toolsData = [
  {
    ...
    description:
      "Professional bidirectional Discord time converter with timezone support and batch processing",
    icon: ArrowLeftRight,
  ...
  },
  {
    ...
    description: "Create dynamic timestamps that automatically update in Discord messages",
    icon: Clock,
  ...
  },
  {
    ...
    description: "Calculate your job's true value with comprehensive salary analysis",
    icon: Calculator,
  ...
  },
  {
    ...
    description: "Professional PDF to Markdown converter with instant conversion",
    icon: FileText,
  ...
  },
  {
    ...
    description:
      "Understand the psychology behind tip screens and their impact on consumer behavior",
    icon: DollarSign,
  ...
  },
  {
    ...
    description:
      "Take the viral Inside Out 2 emotion test to discover which Disney character controls your phone addiction",
    icon: Sparkles,
  ...
  },
  {
    ...
    description: "Create your colorful alter ego inspired by Tyler, the Creator's Chromakopia",
    icon: Palette,
  ...
  },
  {
    ...
    description: "Create professional-grade title cards inspired by the acclaimed animated series",
    icon: Monitor,
  ...
  },
  {
    ...
    description: "Track your PERM application processing times with real-time DOL data",
    icon: Clock,
  ...
  },
  {
    ...
    description:
      "Professional snow day prediction using real-time weather data and advanced algorithms",
    icon: Star,
  ...
  },
  {
    ...
    description:
      "Generate ISO 3779 compliant Vehicle Identification Numbers for automotive software testing",
    icon: Car,
  ...
  },
  {
    ...
    description:
      "Professional JSON to Table converter online. Convert JSON to HTML, ASCII, Excel tables instantly",
    icon: Table,
