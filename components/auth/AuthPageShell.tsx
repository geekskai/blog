...
export default function AuthPageShell({
  ...
  return (
    <section className="relative -mx-4 flex min-h-[calc(100dvh-1rem)] items-start overflow-x-clip px-3 py-5 sm:-mx-6 sm:px-5 sm:py-7 md:items-center md:px-8 md:py-9 lg:py-10 xl:mx-0">
      <div className="relative mx-auto grid w-full max-w-lg overflow-hidden rounded-lg border border-slate-800/80 bg-slate-950/70 shadow-[0_24px_70px_-44px_rgba(14,165,233,0.38)] md:max-w-6xl md:shadow-[0_30px_90px_-48px_rgba(14,165,233,0.4)] lg:max-w-7xl lg:grid-cols-[minmax(0,0.88fr)_minmax(0,1.12fr)]">
        <aside className="relative hidden overflow-hidden border-r border-slate-800/70 bg-slate-900/25 lg:flex lg:flex-col lg:justify-center lg:p-10">
          <div className="relative">
            ...
            <h2 className="mt-3 max-w-[20ch] text-3xl font-bold leading-[1.12] tracking-[-0.035em] text-white">
              Work faster without giving up privacy.
            </h2>
            <p className="mt-4 max-w-[40ch] text-sm leading-7 text-slate-300">
              One lightweight account unlocks daily Audio Credits, billing, and saved settings.
            </p>

            <div className="mt-6 rounded-lg border border-sky-400/20 bg-sky-950/20 p-4">
              <div className="flex items-center justify-between gap-4">
                ...
                <span className="inline-flex items-center gap-1.5 rounded-lg border border-emerald-400/20 bg-emerald-500/10 px-2.5 py-1 text-[11px] font-semibold text-emerald-300">
                  <Check className="h-3 w-3" aria-hidden />
                  Free daily
                </span>
              </div>
              <div className="mt-3 h-1.5 overflow-hidden rounded-lg bg-slate-800">
                <div className="h-full w-3/4 rounded-lg bg-gradient-to-r from-sky-400 to-violet-400" />
              </div>
            </div>
        ...
        <div className="flex items-center justify-center px-4 py-6 sm:px-6 sm:py-8 md:px-10 md:py-9">
          <div className="w-full max-w-md md:max-w-[30rem] lg:max-w-[35rem]">
            <div className="text-left">
              <p className="inline-flex items-center gap-1.5 rounded-lg border border-violet-400/20 bg-violet-500/10 px-3 py-1.5 text-[10px] font-semibold uppercase tracking-[0.14em] text-violet-200 sm:text-[11px]">
              ...
              <p className="mt-2.5 max-w-[50ch] text-sm leading-6 text-slate-300 md:mt-3 md:text-[0.9375rem] md:leading-7">
                {description}
              </p>
