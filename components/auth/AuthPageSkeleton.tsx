...
export default function AuthPageSkeleton({ showConsent = false }: AuthPageSkeletonProps) {
  return (
    <section
      className="relative -mx-4 flex min-h-[calc(100dvh-1rem)] items-start overflow-x-clip px-3 py-5 sm:-mx-6 sm:px-5 sm:py-7 md:items-center md:px-8 md:py-9 lg:py-10 xl:mx-0"
      aria-label="Loading authentication page"
      aria-busy="true"
    >
      <div className="relative mx-auto grid w-full max-w-lg overflow-hidden rounded-lg border border-slate-800/80 bg-slate-950/70 md:max-w-6xl lg:max-w-7xl lg:grid-cols-[minmax(0,0.88fr)_minmax(0,1.12fr)]">
        <aside className="hidden border-r border-slate-800/70 bg-slate-900/25 lg:block lg:p-10">
          <div className="flex h-full flex-col justify-center">
            ...
            <div className="mt-7 rounded-lg border border-slate-800/80 p-4">
              <div className={`${pulse} h-3 w-28`} />
              <div className={`${pulse} mt-3 h-7 w-12`} />
              <div className={`${pulse} mt-4 h-1.5 w-full rounded-lg`} />
            </div>
        ...
        <div className="flex items-center justify-center px-4 py-6 sm:px-6 sm:py-8 md:px-10 md:py-9 lg:px-10 lg:py-10">
          <div className="w-full max-w-md md:max-w-[30rem] lg:max-w-[35rem]">
            <div className={`${pulse} h-7 w-36 rounded-lg`} />
