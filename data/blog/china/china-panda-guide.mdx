...
faqs: [
    {
        question: 'What is the scientific name of the giant panda?',
        answer: 'The scientific name of the giant panda is *Ailuropoda melanoleuca*.'
    },
    {
        question: 'What is the conservation status of giant pandas?',
        answer: 'Giant pandas are currently classified as "vulnerable" on the IUCN Red List of Threatened Species.'
    },
    {
        question: 'How do pandas communicate with each other?',
        answer: 'Pandas communicate through chemical signals to share reproductive status and territory information.'
    },
    {
        question: 'What is the significance of pandas in Chinese culture?',
        answer: 'Pandas have symbolized peace in China since the Western Zhou Dynasty (1046–771 BCE) and play a key role in modern "panda diplomacy."'
    },
    {
        question: 'How do pandas contribute to biodiversity conservation?',
        answer: 'As a flagship species, pandas help protect entire ecosystems by promoting biodiversity and habitat conservation.'
    }
]
---
...
Giant pandas are currently classified as "vulnerable" on the IUCN Red List of Threatened Species.

### How do pandas communicate with each other?

Pandas communicate through chemical signals to share reproductive status and territory information.

### What is the significance of pandas in Chinese culture?

Pandas have symbolized peace in China since the Western Zhou Dynasty (1046–771 BCE) and play a key role in modern "panda diplomacy."

### How do pandas contribute to biodiversity conservation?

As a flagship species, pandas help protect entire ecosystems by promoting biodiversity and habitat conservation.
