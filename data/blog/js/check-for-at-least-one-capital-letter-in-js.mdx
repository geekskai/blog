...
2. **ECMAScript Specification: String.prototype.match()**  
   [String.prototype.match()](https://tc39.es/ecma262/#sec-string.prototype.match)

3. **JavaScript.info: Strings**  
   [Strings](https://javascript.info/string)

4. **Google JavaScript Style Guide**  
   [JavaScript Style Guide](https://google.github.io/styleguide/jsguide.html)

5. **V8 Dev Blog: String Optimization**  
   [String Optimization](https://v8.dev/blog/string-optimization)

6. **TC39 ECMAScript Proposals**  
