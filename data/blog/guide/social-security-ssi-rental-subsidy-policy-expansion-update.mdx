...
faqs:
  [
    {
      question: "What is the eligibility criteria for the expanded SSI rental subsidy?",
      answer: "To qualify for the expanded SSI rental subsidy, you need to be an SSI recipient or a new applicant. You must also meet the Social Security Administration&apos;s requirements. The main factors are showing that you have an active rental agreement and giving proof of your monthly rent amount for review.",
    },
    {
      question: "How will the subsidy amount be calculated?",
      answer: "To find out the rental subsidy amount, we look at your monthly rent compared to the Presumed Maximum Value (PMV). If your rent is higher than the PMV, this is seen as a &apos;business arrangement.&apos; In this case, no rental subsidy will be taken from your SSI benefits. But if your rent is lower than the PMV, some of that difference could be added to your SSI payment.",
    },
    {
      question: "Can existing SSI recipients apply for the expanded rental subsidy?",
      answer: "Existing SSI recipients do not have to fill out a new application for the rental subsidy. The SSA will automatically check current cases to see if they qualify under the new rules. If they do qualify, the updated benefit amounts that include the rental subsidy will be applied automatically.",
    },
    {
      question: "What documentation is needed to apply for the subsidy?",
      answer: "To help with your rental subsidy application, you need to show proof of your rental obligations. You can provide a signed lease, rent receipts, or other official documents that confirm you are responsible for paying rent every month.",
    },
    {
      question: "Where can applicants and recipients find more information and assistance?",
      answer: "For more information and help about the expanded SSI rental subsidy, you can go to the Social Security Administration&apos;s (SSA) official website. You can also contact your local SSA field office. The SSA wants to provide clear and easy-to-understand information to all beneficiaries.",
    },
  ]
