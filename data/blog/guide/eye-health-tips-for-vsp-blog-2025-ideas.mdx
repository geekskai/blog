...
faqs: [
  {
    ...
    answer: 'The VSP in Vermont suggests that you should have eye exams at least once each year. Your eye doctor might suggest a different schedule depending on your age, health, and any risk factors you may have.'
  },
  {
    question: 'Can Blue Light Glasses Improve Eye Health?',
    answer: 'While blue light glasses are sold to help reduce eye strain, the science behind them is unclear. Some people say they work for them, but others do not see any real benefit.'
  }
]
