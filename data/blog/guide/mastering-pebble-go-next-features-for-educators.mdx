...
faqs: [
  {
    question: 'How does Pebble Go Next support differentiated learning?',
    answer: 'PebbleGo Next helps different types of learners. It provides adjustable text levels, a read-aloud feature, and Spanish translations for some content. Teachers can set up unique usernames and passwords for each student. This way, they can make learning more personal.'
  },
  {
    question: 'Can educators track individual student progress in Pebble Go Next?',
    answer: 'Yes, PebbleGo Next helps teachers keep track of each student\'s progress. With its progress monitoring feature, teachers can check login data. They can see quiz scores, activities completed, and how much the students use the program.'
  },
  {
    question: 'What type of content is available in Pebble Go Next for educators?',
    answer: 'Pebble Go Next has a big collection of articles, videos, and activities. It covers many topics like science, social studies, biographies, and animals. These resources are made just for elementary school teachers and their students.'
  }
]
