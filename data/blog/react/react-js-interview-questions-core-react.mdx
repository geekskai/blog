...
<figure>
  <img
    src="/static/images/blog/react/react-js-interview-questions.jpeg"
    alt="React interview questions and answers cover core topics like JSX, components, props, and state."
  />
  <figcaption>Core React interview questions: JSX, components, props, state, and Virtual DOM.</figcaption>
</figure>
...
<section aria-label="Class component example">
...
<details>
<summary><b>See Class</b></summary>
<div>The Props accessed in Class Based Component as below</div>
...
<details>
<summary><b>See Class</b></summary>
<div>The equivalent class stateful component with a state that gets initialized in the `constructor`.</div>
...
<details>
<summary><b>See Class</b></summary>
<div>You can do it by creating _ref_ for `input` element and using it in `componentDidMount()`:</div>
