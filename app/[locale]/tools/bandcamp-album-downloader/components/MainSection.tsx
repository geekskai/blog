...
export function MainSection({ initialUrl }: { initialUrl?: string }) {
  ...
  }, [inspectAlbumUrl, initialUrl, setAlbumUrl])
            ...
            <div className="grid gap-3">
              ...
              <div className="rounded-[22px] border border-white/10 bg-slate-950/60 p-3 sm:p-4">
                <div className="flex flex-col gap-3">
                  ...
                  >
                    {loadingAction === "albumDownload"
                      ? t("actions.inspectingAlbum")
                      : t("actions.inspectAlbum")}
                  </button>
                </div>
              </div>
                ...
                >
                  ...
                  <div className="mt-4 space-y-3">
                    {visibleTracks.length ? (
                      ...
                      <p className="text-sm leading-6 text-slate-400">{t("result.noTrackRows")}</p>
                    )}
                  </div>
