...
function BandcampToMp3PageContent({ initialUrl }: { initialUrl?: string }) {
...
export default async function BandcampToMp3Page({ searchParams }: Props) {
  const initialUrl = (await searchParams).url ?? ""

  return <BandcampToMp3PageContent initialUrl={initialUrl} />
}
