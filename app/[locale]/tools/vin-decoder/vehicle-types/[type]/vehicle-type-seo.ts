...
} from "../../vin-decoder-vs-vin-check/compare-seo"
...
export async function generateVehicleTypePageData(locale: string, config: VehicleTypeConfig) {
  ...
  const pageUrl = `${baseUrl}/tools/vin-decoder/vehicle-types/${config.slug}`
