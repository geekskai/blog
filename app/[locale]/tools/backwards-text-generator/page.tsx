  ...
  return (
    <div className="min-h-screen bg-slate-950">
      <div className="mx-auto max-w-6xl space-y-8 p-4 md:space-y-10 md:p-6">
        ...
        <section className="overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-blue-500/15 via-cyan-500/10 to-indigo-500/15 p-6 shadow-2xl backdrop-blur-xl md:p-8">
