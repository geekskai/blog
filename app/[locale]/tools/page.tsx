...
export default function ToolsPage() {
  ...
  const structuredData = useMemo(() => {
    ...
    const url = getLocalizedUrl(baseUrl, locale, "/tools/")
              ...
              <div className="flex flex-col items-center gap-6">
                <div className="flex flex-col items-center gap-4 sm:flex-row">
                  ...
                  <div className="text-sm text-slate-400">
                    {t("tools_or_scroll_down_to_browse")}
                  </div>
                </div>
          ...
          <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="mx-auto mb-10 max-w-7xl text-lg text-slate-300">
                ...
                <span className="font-semibold text-blue-400">{t("tools_empower_creators")}</span>{" "}
                and{" "}
