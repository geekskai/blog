...
const ContentChunk = () => (
  <article>
    {/* 核心事实块 */}
    <section className="fact-chunk" itemScope itemType="https://schema.org/FAQPage">
      <h2>核心功能</h2>
      <ul>
...
const FactHighlight = ({ fact, value }) => (
  <div className="fact-highlight" itemScope itemType="https://schema.org/PropertyValue">
    <meta itemProp="name" content={fact} />
  ...
  return (
    <section className="core-facts" itemScope itemType="https://schema.org/Product">
      ...
      <dl className="grid gap-4 md:grid-cols-2">
        {coreFacts.map((fact) => (
          <div key={fact.key} itemProp={fact.key}>
