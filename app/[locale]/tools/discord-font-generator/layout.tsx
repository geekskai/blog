...
const SLUG = "discord-font-generator"
...
export async function generateMetadata(props: {
  ...
  const t = await getTranslations({ locale, namespace: "DiscordFontGenerator" })
...
export default async function DiscordFontGeneratorLayout(props: {
