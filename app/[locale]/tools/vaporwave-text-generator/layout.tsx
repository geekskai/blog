...
const SLUG = "vaporwave-text-generator"
...
export async function generateMetadata(props: {
  ...
  const t = await getTranslations({ locale, namespace: "VaporwaveTextGenerator" })
...
export default async function VaporwaveTextGeneratorLayout(props: {
