...
export default function StrikethroughTextToolPage() {
  const t = useTranslations("StrikethroughTextGenerator")
  ...
  return (
    <UnicodeToolTemplate
      ...
      enabledEffectIds={["plain", "strikethrough", "wavy-underline"]}
